...
* [动态宏文档](zh-cn/feature_dynamic_macros)

## Eclipse
是一种受C语言开发者追捧的集成开发环境(IDE)。

* [Eclipse安装说明](zh-cn/other_eclipse)
...
## Keycode(键码)
表示特定键的2字节数据。`0x00`-`0xFF`用于[基本键码](zh-cn/keycodes_basic)而`0x100`-`0xFFFF`用于[量子键码](zh-cn/quantum_keycodes).
...
* [前导键文档](zh-cn/feature_leader_key)
...
* [鼠标键文档](zh-cn/feature_mouse_keys)
...
* [Space Cadet键盘文档](zh-cn/feature_space_cadet)
...
* [Unicode文档](zh-cn/feature_unicode)

## Unit Testing(单元测试)
针对qmk的自动测试框架。单元测试帮助我们确信我们的更改不会破坏任何东西。

* [单元测试文档](zh-cn/unit_testing)
